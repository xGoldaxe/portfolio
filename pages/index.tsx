...
import {
  MakeCancelableReturn,
  makeCancelable,
} from "../src/js/lib/cancelablePromise";
import TopBar from "../components/TopBar";

export default function Home({ handleTransition, transitionOver }) {
  const [skillTl, setSkillTl] = useState<gsap.core.Timeline | null>(null);
  const [cancelablePromise, setCancelablePromise] =
    useState<MakeCancelableReturn | null>(null);
  ...
  useEffect(() => {
    if (transitionOver) {
      ...
      const cancelPromise = makeCancelable(
        new Promise((resolve) => {
          homeAppear(resolve);
        })
      );
      cancelPromise.promise
        ...
        .catch((reason) => {});
      setCancelablePromise(cancelPromise);
    }
    return () => {
